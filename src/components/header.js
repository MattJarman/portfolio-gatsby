        ...
        <div className="w-full mx-auto">
          <div
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <a href="https://github.com/MattJarman" target="_blank"
                 className="flex items-center justify-center mr-3" rel="noreferrer">
              </a>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center justify-center w-6 text-green-500">
                            <Icon className="text-green-500 dark:text-green-400 text-xl fill-current" name={icon} />
                          </div>
